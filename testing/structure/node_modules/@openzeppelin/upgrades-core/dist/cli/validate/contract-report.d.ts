 ...
 */
export declare function getContractReports(sourceContracts: SourceContract[], opts: ValidateUpgradeSafetyOptions, specifiedContracts?: SpecifiedContracts): UpgradeableContractReport[];
